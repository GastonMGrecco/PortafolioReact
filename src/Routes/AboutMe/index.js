...
const Sobremi = () => {
    return (
        <div className={style.container}>
            <img id={style.aboutMe} src={icono} alt="Me" />
            <div className={style.containerText}>

                <p className={style.Iam}>Hola, mi nombre es Gastón Maximiliano Grecco.
                ...
                <p className={style.Iam}>Hello, my name is Gastón Maximiliano Grecco.

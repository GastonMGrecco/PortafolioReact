    ...
    return (
        <div className="container">
             ...
             <p className="Iam">Hola, mi nombre es Gastón Maximiliano Grecco. 
                 ...
                 como "react-router-dom","react-redux" y "react-thank", entre las principales.
                 ...
                 ya que no le he dedicado el tiempo debido, pero la parte funcional está en orden.
            ...
            <p className="Iam">Hello, my name is Gastón Maximiliano Grecco. 
                 ...
                 I decided to reinforce my knowledge in a self-dictated way, through books or the internet.Currently 
                 I am in a "FullStack" development bootcamp. At the moment, I can
                 ...
                 such as "react-router-dom", "react-redux" and "react-thank", among the main ones.
                 I invite you to see my React portfolio so you can experience a little of what I know how to do.
                 I'm yet to finish one last shopping cart project, but I hope to finish it soon.
                 As you will see, I need to give design touches with css to much of this portfolio, 
                 since I have not dedicated the due time to it, but the functional part is in order.
